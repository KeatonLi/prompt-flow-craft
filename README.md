...
┌────────────────────────▼────────────────────────────────────┐
│                    Data Layer (MySQL)                      │
│         PromptCache │ Category │ Tag │ Statistics          │
└─────────────────────────────────────────────────────────────┘
```
...
| `/api/categories/{id}/prompts` | GET | 获取分类下的提示词 |
...
| `/api/tags/system` | GET | 获取系统预设标签 |
| `/api/tags/search` | GET | 搜索标签 |
| `/api/tags/admin/untagged-count` | GET | 获取未打标签数量 |
| `/api/tags/admin/auto-tag` | POST | 批量自动打标签 |
